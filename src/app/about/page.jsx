      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Experienced Full Stack Web Developer proficient in the MEARN stack
              (MongoDB, Express.js, Angular, React, Node.js) with a strong
              background in backend development. Skilled in developing robust
              web applications using Node.js, Django REST, and front-end
              technologies like React and Angular. Proficient in database
              management (SQL, MongoDB) and version control (GIT). Familiar with
              automated testing and Agile methodologies. Dedicated to delivering
              innovative solutions and driving business success through
              technology.
            </p>
            {/* BIOGRAPHY QUOTE */}
